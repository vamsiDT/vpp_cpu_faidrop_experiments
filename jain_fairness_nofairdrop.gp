...
set out "jain_fairness_nofairdrop.pdf"
...
plot \
'NOFAIRDROP_CPU_RESULTS/jain_nofdthf.dat' every 2:2 u ($0+1):6 title "Throughput Jain fairness Index" lw 2 w lp,\
'NOFAIRDROP_CPU_RESULTS/jain_nofdthf.dat' every 2:2:1 u ($0+1):6 title "Clock Cycle Jain fairness Index" lw 2 w lp
