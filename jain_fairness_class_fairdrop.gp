...
set out "jain_fairness_class_fairdrop.pdf"
...
plot \
'FAIRDROP_CPU_RESULTS_1/jain_fairness_thf_class.dat' u ($0+1):6 title "Throughput Jain fairness Index" lw 2 w lp,\
'FAIRDROP_CPU_RESULTS_1/jain_fairness_thf_class.dat' u ($0+1):10 title "Clock Cycle Jain fairness Index" lw 2 w lp
