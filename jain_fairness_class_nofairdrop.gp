...
set out "jain_fairness_class_nofairdrop.pdf"
...
plot \
'NOFAIRDROP_CPU_RESULTS/jain_nofdthf_class.dat' u ($0+1):6 title "Throughput Jain fairness Index" lw 2 w lp,\
'NOFAIRDROP_CPU_RESULTS/jain_nofdthf_class.dat' u ($0+1):10 title "Clock Cycle Jain fairness Index" lw 2 w lp
