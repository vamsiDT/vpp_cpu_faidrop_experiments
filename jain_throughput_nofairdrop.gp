...
set out "jain_throughput_nofairdrop.pdf"
...
plot \
'NOFAIRDROP_jainfairness.dat' every 2:2 u ($0+1):5 title "Throughput Jain fairness Index" lw 2 w lp,\
'NOFAIRDROP_jainfairness.dat' every 2:2:1 u ($0+1):6 title "Clock Cycle Jain fairness Index" lw 2 w lp
